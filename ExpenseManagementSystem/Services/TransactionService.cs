...
public class TransactionService(IGenericRepository genericRepository, IUserServices userService, ITagServices tagService) : ITransactionServices
{
    ...
    public async Task<TransactionCountGetDto> TransactionCountGet()
    {
        var userDetails = await userService.FetchUserDetail();
        ...
        return new TransactionCountGetDto()
        {
    ...
    public GetTransactionDto GetTransactionById(Guid transactionId)
    {
        ...
        {
            var tag = tagService.GetTagFromID(transactionTag.TagId);
    ...
    public async Task<List<GetTransactionDto>> GetAllTransactions(GetTransactionFilterRequestDto transactionFilterRequest)
    {
        ...
        foreach (var transaction in transactions)
        {
            ...
            {
                var tags = transactionTagsModel.Select(transactionTag => tagService.GetTagFromID(transactionTag.TagId)).ToList();
    ...
    public async Task InsertIntoTransaction(InsertIntoTransactionDto transaction)
    {
        var userDetails = await userService.FetchUserDetail();
        ...
        {
            var tag = tagService.GetTagFromID(tagId);
